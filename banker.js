var res,pro;
        var resource;
			function BuildFormFields($amt) // For Resorce allocation
			{
            ...
            function BuildFormFields2($amt) //For Allocation
			{
				pro = $amt;
				if($amt<0)
                	alert("Invalid Inputs");
                ...
                BuildFormFields3($amt);
            }
			function BuildFormFields3($amt) //For Allocation
			{
				if($amt<0)
					alert("Invalid Inputs");
                console.log(res);
			...
			function banker()
			{
						...
						while(1)
						{
							...
							for (i = 0; i < pro; i++)
							{
								...
								{
                                    var li = document.createElement("li");
                                    li.appendChild(document.createTextNode("Process "+ (i+1)+": "));
                                    ul1.append(li);
									...
									if(flag)
									{
                                        ...
                                        var li = document.createElement("li");
                                        li.appendChild(document.createTextNode("Process " + (i+1) + " doesn't have enough resources"));
                                        ul2.append(li);
                                        ul1.append(ul2);
                                        prints.appendChild(ul1);
                                        var li = document.createElement("li");
